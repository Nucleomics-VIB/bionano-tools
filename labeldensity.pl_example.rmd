...
The colors for the heatmap view were taken from the quantiles in the above plot. The horizontal lin ein teh lower plot corresponds to the median value of the distribution.
