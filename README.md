...
The BIO-perl script [fastaRename.pl](fasta-tools/fastaRename.pl) will rename headers of a multifasta file using the index file generated by Knicker (BionanoGenomics). The resulting fiel can be used with data exported from BNG in IGV.
```bash
## Usage: 
